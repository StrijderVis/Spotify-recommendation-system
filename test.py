...
if "code" in st.query_params:
    ...
    st.write("Top 10 gelikede nummers:", top_liked_track_names)
    ...
    st.write("Top 10 nummers:", top_top_track_names)

    # Gebruik alleen maximaal 5 seed_tracks
    seed_tracks = (top_track_ids + liked_track_ids)[:5]
